...
function usePresence(present: boolean) {
  ...
  useLayoutEffect(() => {
    if (node) {
      ...
      /**
       * Triggering an ANIMATION_OUT during an ANIMATION_IN will fire an `animationcancel` event for ANIMATION_IN after
       * we have entered `unmountSuspended` state. So, we make sure we only trigger ANIMATION_END for the currently
       * active animation.
       */
