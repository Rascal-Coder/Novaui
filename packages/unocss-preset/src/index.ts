 ...
 */
export function presetNovaui(options: PresetShadcnOptions = {}, globals = true): Preset<Theme> {
  return {
    name: 'unocss-preset-novaui',
    preflights: [
      {
        getCSS: () => `
